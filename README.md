...
## Rust Trending (2026-03-08 01:28:38)
...
| [tauri](https://www.github.com/tauri-apps/tauri) | tauri-apps | 103.8k | Build smaller, faster, and more secure desktop and mobile applications with a web frontend. |
...
| [zed](https://www.github.com/zed-industries/zed) | zed-industries | 76.6k | Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter. |
...
| [codex](https://www.github.com/openai/codex) | openai | 63.7k | Lightweight coding agent that runs in your terminal |
...
| [goose](https://www.github.com/block/goose) | block | 32.6k | an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM |
| [qdrant](https://www.github.com/qdrant/qdrant) | qdrant | 29.4k | Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next generation of AI. Also available in the cloud https://cloud.qdrant.io/ |
...
| [zeroclaw](https://www.github.com/zeroclaw-labs/zeroclaw) | zeroclaw-labs | 24.3k | Fast, small, and fully autonomous AI assistant infrastructure — deploy anywhere, swap anything 🦀 |
| [vibe-kanban](https://www.github.com/BloopAI/vibe-kanban) | BloopAI | 22.6k | Get 10X more out of Claude Code, Codex or any coding agent |
| [agent-browser](https://www.github.com/vercel-labs/agent-browser) | vercel-labs | 19.8k | Browser automation CLI for AI agents |
