...
## Rust Trending (2026-04-01 03:19:30)
...
| [claw-code](https://www.github.com/instructkr/claw-code) | instructkr | 73.0k | The fastest repo in history to surpass 50K stars ⭐, reaching the milestone in just 2 hours after publication. Better Harness Tools, not merely storing the archive of leaked Claude Code but make real things done. Now rewriting in Rust using oh-my-codex. |
| [codex](https://www.github.com/openai/codex) | openai | 70.4k | Lightweight coding agent that runs in your terminal |
...
| [vibe-kanban](https://www.github.com/BloopAI/vibe-kanban) | BloopAI | 24.2k | Get 10X more out of Claude Code, Codex or any coding agent |
