...
## Rust Trending (2026-05-01 17:02:22)

### Top Trending Rust Repositories

| Name | Developer | Stars | Description |
|------|-----------|-------|-------------|
| [claw-code](https://www.github.com/ultraworkers/claw-code) | ultraworkers | 189.5k | The repo is finally unlocked. enjoy the party! The fastest repo in history to surpass 100K stars ⭐. Join Discord: https://discord.gg/5TUQKqFWd Built in Rust using oh-my-codex. |
| [rustdesk](https://www.github.com/rustdesk/rustdesk) | rustdesk | 113.3k | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer. |
...
| [zed](https://www.github.com/zed-industries/zed) | zed-industries | 81.1k | Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter. |
| [codex](https://www.github.com/openai/codex) | openai | 79.4k | Lightweight coding agent that runs in your terminal |
...
| [warp](https://www.github.com/warpdotdev/warp) | warpdotdev | 51.1k | Warp is an agentic development environment, born out of the terminal. |
...
| [rtk](https://www.github.com/rtk-ai/rtk) | rtk-ai | 39.3k | CLI proxy that reduces LLM token consumption by 60-90% on common dev commands. Single Rust binary, zero dependencies |
| [tabby](https://www.github.com/TabbyML/tabby) | TabbyML | 33.5k | Self-hosted AI coding assistant |
| [agent-browser](https://www.github.com/vercel-labs/agent-browser) | vercel-labs | 31.3k | Browser automation CLI for AI agents |
