...
## Rust Trending (2026-09-13 18:39:44)
...
| [clash-verge-rev](https://www.github.com/clash-verge-rev/clash-verge-rev) | clash-verge-rev | 144.2k | A modern GUI client based on Tauri, designed to run in Windows, macOS and Linux for tailored proxy experience |
| [cc-switch](https://www.github.com/farion1231/cc-switch) | farion1231 | 132.6k | A cross-platform desktop All-in-One assistant for Claude Code, Codex, OpenCode, OpenClaw, Grok Build & Hermes Agent. Only official website: ccswitch.io |
| [codex](https://www.github.com/openai/codex) | openai | 123.8k | Lightweight coding agent that runs in your terminal |
| [rustdesk](https://www.github.com/rustdesk/rustdesk) | rustdesk | 123.3k | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer. |
...
| [RuView](https://www.github.com/ruvnet/RuView) | ruvnet | 93.4k | π RuView turns commodity WiFi signals into real-time spatial intelligence, vital sign monitoring, and presence detection — all without a single pixel of video. |
