...
## Rust Trending (2026-03-07 01:22:04)

### Top Trending Rust Repositories

| Name | Developer | Stars | Description |
|------|-----------|-------|-------------|
| [rust](https://www.github.com/rust-lang/rust) | rust-lang | 111.0k | Empowering everyone to build reliable and efficient software. |
| [rustdesk](https://www.github.com/rustdesk/rustdesk) | rustdesk | 108.8k | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer. |
...
| [uv](https://www.github.com/astral-sh/uv) | astral-sh | 80.4k | An extremely fast Python package and project manager, written in Rust. |
...
| [codex](https://www.github.com/openai/codex) | openai | 63.6k | Lightweight coding agent that runs in your terminal |
...
| [zeroclaw](https://www.github.com/zeroclaw-labs/zeroclaw) | zeroclaw-labs | 24.0k | Fast, small, and fully autonomous AI assistant infrastructure — deploy anywhere, swap anything 🦀 |
