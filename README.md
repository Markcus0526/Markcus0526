...
## Rust Trending (2026-03-06 01:29:24)
...
| [rustdesk](https://www.github.com/rustdesk/rustdesk) | rustdesk | 108.7k | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer. |
| [deno](https://www.github.com/denoland/deno) | denoland | 106.3k | A modern runtime for JavaScript and TypeScript. |
| [tauri](https://www.github.com/tauri-apps/tauri) | tauri-apps | 103.7k | Build smaller, faster, and more secure desktop and mobile applications with a web frontend. |
...
| [zed](https://www.github.com/zed-industries/zed) | zed-industries | 76.5k | Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter. |
...
| [codex](https://www.github.com/openai/codex) | openai | 63.3k | Lightweight coding agent that runs in your terminal |
| [alacritty](https://www.github.com/alacritty/alacritty) | alacritty | 62.8k | A cross-platform, OpenGL terminal emulator. |
| [rustlings](https://www.github.com/rust-lang/rustlings) | rust-lang | 62.1k | :crab: Small exercises to get you used to reading and writing Rust code! |
...
| [goose](https://www.github.com/block/goose) | block | 32.5k | an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM |
...
| [zeroclaw](https://www.github.com/zeroclaw-labs/zeroclaw) | zeroclaw-labs | 23.6k | Fast, small, and fully autonomous AI assistant infrastructure — deploy anywhere, swap anything 🦀 |
| [vibe-kanban](https://www.github.com/BloopAI/vibe-kanban) | BloopAI | 22.5k | Get 10X more out of Claude Code, Codex or any coding agent |
