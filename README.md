...
## Rust Trending (2026-03-24 17:06:06)
...
| [rustdesk](https://www.github.com/rustdesk/rustdesk) | rustdesk | 109.9k | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer. |
...
| [uv](https://www.github.com/astral-sh/uv) | astral-sh | 81.9k | An extremely fast Python package and project manager, written in Rust. |
| [zed](https://www.github.com/zed-industries/zed) | zed-industries | 77.8k | Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter. |
...
| [codex](https://www.github.com/openai/codex) | openai | 67.3k | Lightweight coding agent that runs in your terminal |
...
| [goose](https://www.github.com/block/goose) | block | 33.5k | an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM |
...
| [zeroclaw](https://www.github.com/zeroclaw-labs/zeroclaw) | zeroclaw-labs | 28.6k | Fast, small, and fully autonomous AI personal assistant infrastructure, ANY OS, ANY PLATFORM — deploy anywhere, swap anything 🦀 |
...
| [agent-browser](https://www.github.com/vercel-labs/agent-browser) | vercel-labs | 24.6k | Browser automation CLI for AI agents |
