...
## Rust Trending (2026-04-21 09:44:54)

### Top Trending Rust Repositories

| Name | Developer | Stars | Description |
|------|-----------|-------|-------------|
| [claw-code](https://www.github.com/ultraworkers/claw-code) | ultraworkers | 186.9k | The repo is finally unlocked. enjoy the party! The fastest repo in history to surpass 100K stars ⭐. Join Discord: https://discord.gg/5TUQKqFWd Built in Rust using oh-my-codex. |
...
| [codex](https://www.github.com/openai/codex) | openai | 76.7k | Lightweight coding agent that runs in your terminal |
...
| [rtk](https://www.github.com/rtk-ai/rtk) | rtk-ai | 31.2k | CLI proxy that reduces LLM token consumption by 60-90% on common dev commands. Single Rust binary, zero dependencies |
