...
## Rust Trending (2026-03-05 01:26:58)

### Top Trending Rust Repositories

| Name | Developer | Stars | Description |
|------|-----------|-------|-------------|
| [rust](https://www.github.com/rust-lang/rust) | rust-lang | 110.9k | Empowering everyone to build reliable and efficient software. |
| [rustdesk](https://www.github.com/rustdesk/rustdesk) | rustdesk | 108.6k | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer. |
| [deno](https://www.github.com/denoland/deno) | denoland | 106.3k | A modern runtime for JavaScript and TypeScript. |
| [tauri](https://www.github.com/tauri-apps/tauri) | tauri-apps | 103.6k | Build smaller, faster, and more secure desktop and mobile applications with a web frontend. |
| [uv](https://www.github.com/astral-sh/uv) | astral-sh | 80.3k | An extremely fast Python package and project manager, written in Rust. |
| [zed](https://www.github.com/zed-industries/zed) | zed-industries | 76.4k | Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter. |
...
| [codex](https://www.github.com/openai/codex) | openai | 63.0k | Lightweight coding agent that runs in your terminal |
| [alacritty](https://www.github.com/alacritty/alacritty) | alacritty | 62.8k | A cross-platform, OpenGL terminal emulator. |
...
| Name | Developer | Stars | Description |
|------|-----------|-------|-------------|
| [meilisearch](https://www.github.com/meilisearch/meilisearch) | meilisearch | 56.2k | A lightning-fast search engine API bringing AI-powered hybrid search to your sites and applications. |
| [tabby](https://www.github.com/TabbyML/tabby) | TabbyML | 33.0k | Self-hosted AI coding assistant |
| [goose](https://www.github.com/block/goose) | block | 32.4k | an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM |
| [qdrant](https://www.github.com/qdrant/qdrant) | qdrant | 29.3k | Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next generation of AI. Also available in the cloud https://cloud.qdrant.io/ |
| [chroma](https://www.github.com/chroma-core/chroma) | chroma-core | 26.5k | Open-source search and retrieval database for AI applications. |
...
| [vibe-kanban](https://www.github.com/BloopAI/vibe-kanban) | BloopAI | 22.4k | Get 10X more out of Claude Code, Codex or any coding agent |
| [cube](https://www.github.com/cube-js/cube) | cube-js | 19.6k | 📊 Cube Core is open-source semantic layer for AI, BI and embedded analytics |
| [agent-browser](https://www.github.com/vercel-labs/agent-browser) | vercel-labs | 18.6k | Browser automation CLI for AI agents |
| [screenpipe](https://www.github.com/screenpipe/screenpipe) | screenpipe | 17.1k | screenpipe turns your computer into a personal AI that knows everything you've done. record. search. automate. all local, all private, all yours. |
