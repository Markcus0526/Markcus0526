...
## Rust Trending (2026-03-11 01:23:10)
...
| [rustdesk](https://www.github.com/rustdesk/rustdesk) | rustdesk | 109.0k | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer. |
| [deno](https://www.github.com/denoland/deno) | denoland | 106.4k | A modern runtime for JavaScript and TypeScript. |
| [tauri](https://www.github.com/tauri-apps/tauri) | tauri-apps | 104.0k | Build smaller, faster, and more secure desktop and mobile applications with a web frontend. |
| [uv](https://www.github.com/astral-sh/uv) | astral-sh | 80.7k | An extremely fast Python package and project manager, written in Rust. |
| [zed](https://www.github.com/zed-industries/zed) | zed-industries | 76.8k | Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter. |
...
| [codex](https://www.github.com/openai/codex) | openai | 64.4k | Lightweight coding agent that runs in your terminal |
...
| [goose](https://www.github.com/block/goose) | block | 32.8k | an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM |
...
| [zeroclaw](https://www.github.com/zeroclaw-labs/zeroclaw) | zeroclaw-labs | 25.8k | Fast, small, and fully autonomous AI assistant infrastructure — deploy anywhere, swap anything 🦀 |
...
| [vibe-kanban](https://www.github.com/BloopAI/vibe-kanban) | BloopAI | 22.9k | Get 10X more out of Claude Code, Codex or any coding agent |
| [agent-browser](https://www.github.com/vercel-labs/agent-browser) | vercel-labs | 20.7k | Browser automation CLI for AI agents |
