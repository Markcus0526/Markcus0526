...
## Rust Trending (2026-03-01 01:47:00)
...
| [rustdesk](https://www.github.com/rustdesk/rustdesk) | rustdesk | 108.4k | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer. |
| [deno](https://www.github.com/denoland/deno) | denoland | 106.3k | A modern runtime for JavaScript and TypeScript. |
| [tauri](https://www.github.com/tauri-apps/tauri) | tauri-apps | 103.4k | Build smaller, faster, and more secure desktop and mobile applications with a web frontend. |
| [uv](https://www.github.com/astral-sh/uv) | astral-sh | 80.0k | An extremely fast Python package and project manager, written in Rust. |
| [zed](https://www.github.com/zed-industries/zed) | zed-industries | 76.1k | Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter. |
...
| [codex](https://www.github.com/openai/codex) | openai | 62.4k | Lightweight coding agent that runs in your terminal |
...
| [goose](https://www.github.com/block/goose) | block | 31.5k | an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM |
...
| [vibe-kanban](https://www.github.com/BloopAI/vibe-kanban) | BloopAI | 22.1k | Get 10X more out of Claude Code, Codex or any coding agent |
| [zeroclaw](https://www.github.com/zeroclaw-labs/zeroclaw) | zeroclaw-labs | 21.2k | Fast, small, and fully autonomous AI assistant infrastructure — deploy anywhere, swap anything 🦀 |
