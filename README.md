...
## Rust Trending (2026-09-14 14:52:53)
...
| [clash-verge-rev](https://www.github.com/clash-verge-rev/clash-verge-rev) | clash-verge-rev | 144.4k | A modern GUI client based on Tauri, designed to run in Windows, macOS and Linux for tailored proxy experience |
| [cc-switch](https://www.github.com/farion1231/cc-switch) | farion1231 | 132.8k | A cross-platform desktop All-in-One assistant for Claude Code, Codex, OpenCode, OpenClaw, Grok Build & Hermes Agent. Only official website: ccswitch.io |
| [codex](https://www.github.com/openai/codex) | openai | 124.1k | Lightweight coding agent that runs in your terminal |
...
| [RuView](https://www.github.com/ruvnet/RuView) | ruvnet | 93.7k | π RuView turns commodity WiFi signals into real-time spatial intelligence, vital sign monitoring, and presence detection — all without a single pixel of video. |
...
| [cc-switch](https://www.github.com/farion1231/cc-switch) | farion1231 | 132.8k | A cross-platform desktop All-in-One assistant for Claude Code, Codex, OpenCode, OpenClaw, Grok Build & Hermes Agent. Only official website: ccswitch.io |
| [codex](https://www.github.com/openai/codex) | openai | 124.1k | Lightweight coding agent that runs in your terminal |
| [rtk](https://www.github.com/rtk-ai/rtk) | rtk-ai | 80.3k | CLI proxy that reduces LLM token consumption by 60-90% on common dev commands. Single Rust binary, zero dependencies |
