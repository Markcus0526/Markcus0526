...
## Rust Trending (2026-03-03 01:29:40)

### Top Trending Rust Repositories

| Name | Developer | Stars | Description |
|------|-----------|-------|-------------|
| [rust](https://www.github.com/rust-lang/rust) | rust-lang | 110.8k | Empowering everyone to build reliable and efficient software. |
| [rustdesk](https://www.github.com/rustdesk/rustdesk) | rustdesk | 108.5k | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer. |
| [deno](https://www.github.com/denoland/deno) | denoland | 106.3k | A modern runtime for JavaScript and TypeScript. |
| [tauri](https://www.github.com/tauri-apps/tauri) | tauri-apps | 103.5k | Build smaller, faster, and more secure desktop and mobile applications with a web frontend. |
| [uv](https://www.github.com/astral-sh/uv) | astral-sh | 80.1k | An extremely fast Python package and project manager, written in Rust. |
| [zed](https://www.github.com/zed-industries/zed) | zed-industries | 76.2k | Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter. |
...
| [codex](https://www.github.com/openai/codex) | openai | 62.7k | Lightweight coding agent that runs in your terminal |
...
| [goose](https://www.github.com/block/goose) | block | 32.2k | an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM |
| [qdrant](https://www.github.com/qdrant/qdrant) | qdrant | 29.2k | Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next generation of AI. Also available in the cloud https://cloud.qdrant.io/ |
| [chroma](https://www.github.com/chroma-core/chroma) | chroma-core | 26.4k | Open-source search and retrieval database for AI applications. |
...
| [zeroclaw](https://www.github.com/zeroclaw-labs/zeroclaw) | zeroclaw-labs | 22.3k | Fast, small, and fully autonomous AI assistant infrastructure — deploy anywhere, swap anything 🦀 |
| [vibe-kanban](https://www.github.com/BloopAI/vibe-kanban) | BloopAI | 22.2k | Get 10X more out of Claude Code, Codex or any coding agent |
